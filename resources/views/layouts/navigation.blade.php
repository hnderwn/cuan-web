<div x-data="{ dropdownOpen: false }" class="relative">
    <button @click="dropdownOpen = !dropdownOpen" class="flex items-center space-x-2 relative focus:outline-none">
        <h2 class="text-brand-darkest text-sm font-semibold">{{ Auth::user()->name }}</h2>
        <svg class="h-5 w-5 text-brand-darkest" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
