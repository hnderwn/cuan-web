        ...
        <div>
            <span class="relative z-0 inline-flex shadow-sm rounded-lg">
                ...
                <span aria-current="page">
                    <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-brand-darkest border border-brand-dark cursor-default leading-5">{{ $page }}</span>
                </span>
                @else
